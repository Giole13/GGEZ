...
namespace WhatIsInterface
{
    internal class Description
    {
         ...
         * 보겠다. 인터페이스는 클래스에서 구현해야 하는 관련 기능의 정의가 포함된 개념이다.
         * 
         * 인터페이스
         ...
         *  - C#에서 인터페이스의 이름은 ICar, IFood, IComputer 형태로 대문자
         *      I로 시작한다.
    ...
    class Car : ICar    // 인터페이스에서 상속 받으면 무조건 인터페이스를 구현해야함
    {
        public virtual void Go()
        {
            Console.WriteLine("자동자가 앞으로 간다.");
